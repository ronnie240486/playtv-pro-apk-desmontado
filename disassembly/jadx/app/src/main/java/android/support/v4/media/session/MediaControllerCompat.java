...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public void postToHandler(int i7, Object obj, Bundle bundle) {
            ...
            if (messageHandler != null) {
                Message messageObtainMessage = messageHandler.obtainMessage(i7, obj);
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i7, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(j.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.mSessionToken.setSession2Token(h.M(bundle));
        ...
        public TransportControls getTransportControls() {
            ...
            return i7 >= 23 ? new TransportControlsApi23(transportControls) : new TransportControlsApi21(transportControls);
        }
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        public void setCaptioningEnabled(boolean z6) {
            Bundle bundle = new Bundle();
            bundle.putBoolean(MediaSessionCompat.ACTION_ARGUMENT_CAPTIONING_ENABLED, z6);
    ...
    public static class TransportControlsBase extends TransportControls {
        ...
        public void setCaptioningEnabled(boolean z6) {
            try {
                this.mBinder.setCaptioningEnabled(z6);
            } catch (RemoteException e7) {
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException(m.k("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(int i7, int i8, int i9, int i10, int i11) {
            a aVar = new a(11);
            ((p035e0.a) aVar.f11010z).s(i8);
            this(i7, new AudioAttributesCompat(((p035e0.a) aVar.f11010z).build()), i9, i10, i11);
        }
        ...
        public int getAudioStream() {
            return this.mAudioAttrsCompat.f10345a.a();
        }
