...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final b METADATA_KEYS_TYPE;
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmap(Bitmap bitmap, int i7) {
            float f7 = i7;
            float fMin = Math.min(f7 / bitmap.getWidth(), f7 / bitmap.getHeight());
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            b bVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
        ...
        public Builder putLong(String str, long j7) {
            ...
            if (bVar.containsKey(str) && ((Integer) bVar.getOrDefault(str, null)).intValue() != 0) {
                throw new IllegalArgumentException(m.k("The ", str, " key cannot be used to put a long"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            b bVar = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (bVar.containsKey(str) && ((Integer) bVar.getOrDefault(str, null)).intValue() != 1) {
                throw new IllegalArgumentException(m.k("The ", str, " key cannot be used to put a CharSequence"));
            }
