...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i7, Bundle bundle) {
            ...
            StringBuilder sbP = m.p("Unknown result code: ", i7, " (extras=");
            sbP.append(this.mExtras);
            sbP.append(", resultData=");
            sbP.append(bundle);
            sbP.append(")");
            Log.w(MediaBrowserCompat.TAG, sbP.toString());
        }
    }
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void onConnected() {
            try {
                ...
                IBinder iBinderA = j.a(extras, "extra_messenger");
                if (iBinderA != null) {
                ...
                IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(j.a(extras, "extra_session_binder"));
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder sbQ = m.q(str, " for ");
                sbQ.append(MediaBrowserImplBase.this.mServiceComponent);
                sbQ.append(" with mServiceConnection=");
                sbQ.append(MediaBrowserImplBase.this.mServiceConnection);
                sbQ.append(" this=");
                sbQ.append(this);
                Log.i(MediaBrowserCompat.TAG, sbQ.toString());
                return false;
            }
        ...
        private static String getStateLabel(int i7) {
            ...
            if (i7 != 3) {
                return i7 != 4 ? m.h("UNKNOWN/", i7) : "CONNECT_STATE_SUSPENDED";
            }
        ...
        public void connect() {
            int i7 = this.mState;
            if (i7 != 0 && i7 != 1) {
                throw new IllegalStateException(m.n(new StringBuilder("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(m.n(new StringBuilder("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(m.n(new StringBuilder("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(m.l(new StringBuilder("getServiceComponent() called while not connected (state="), this.mState, ")"));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(m.l(new StringBuilder("getSessionToken() called while not connected(state="), this.mState, ")"));
        }
        ...
        public void onServiceConnected(Messenger messenger, String str, MediaSessionCompat.Token token, Bundle bundle) {
            if (isCurrent(messenger, "onConnect")) {
                ...
                try {
                    for (Map.Entry entry : (i) this.mSubscriptions.entrySet()) {
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(m.n(new StringBuilder("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException e7) {
    ...
    public static class ServiceBinderWrapper {
        ...
        public void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString("data_media_item_id", str);
            j.b(bundle, "data_callback_token", iBinder);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i7 = 0; i7 < this.mOptionsList.size(); i7++) {
                if (e.d(this.mOptionsList.get(i7), bundle)) {
