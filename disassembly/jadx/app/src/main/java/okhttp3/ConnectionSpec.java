...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z6) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            q0.i(enabledCipherSuites2, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            q0.i(enabledProtocols2, "sslSocket.enabledProtocols");
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, a.f2958y);
        } else {
            enabledProtocols = sSLSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
        q0.i(supportedCipherSuites, "supportedCipherSuites");
        int iIndexOf = Util.indexOf(supportedCipherSuites, "TLS_FALLBACK_SCSV", CipherSuite.Companion.getORDER_BY_NAME$okhttp());
        if (z6 && iIndexOf != -1) {
            q0.i(enabledCipherSuites, "cipherSuitesIntersection");
            String str = supportedCipherSuites[iIndexOf];
            q0.i(str, "supportedCipherSuites[indexOfFallbackScsv]");
        ...
        q0.i(enabledProtocols, "tlsVersionsIntersection");
    ...
    public final List<CipherSuite> m45deprecated_cipherSuites() {
        return cipherSuites();
    }

    /* JADX INFO: renamed from: -deprecated_supportsTlsExtensions, reason: not valid java name */
    public final boolean m46deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }

    /* JADX INFO: renamed from: -deprecated_tlsVersions, reason: not valid java name */
    public final List<TlsVersion> m47deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        q0.j(sSLSocket, "socket");
        if (!this.isTls) {
            return false;
        }
        String[] strArr = this.tlsVersionsAsString;
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), a.f2958y)) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuiteArr) {
            q0.j(cipherSuiteArr, "cipherSuites");
            if (!getTls$okhttp()) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections".toString());
            }
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersionArr) {
            q0.j(tlsVersionArr, "tlsVersions");
            if (!getTls$okhttp()) {
                throw new IllegalArgumentException("no TLS versions for cleartext connections".toString());
            }
