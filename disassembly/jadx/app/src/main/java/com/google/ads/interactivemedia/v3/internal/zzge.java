...
public final class zzge implements AdEvent.AdEventListener, AdErrorEvent.AdErrorListener, zzen, zzfl {
    ...
    private final void zzj(List list) {
        com.google.ads.interactivemedia.v3.impl.data.zzbn zzbnVarBuild;
        if (list == null) {
            zzbnVarBuild = null;
        } else if (list.isEmpty()) {
            return;
        } else {
            zzbnVarBuild = com.google.ads.interactivemedia.v3.impl.data.zzbn.builder().friendlyObstructions(list).build();
        }
        this.zza.zzp(new zzff(zzfd.omid, zzfe.registerFriendlyObstructions, this.zze, zzbnVarBuild));
    }
    ...
    public final void onAdEvent(AdEvent adEvent) {
        if (this.zzg) {
            ...
            if (iOrdinal == 15 && this.zzg && this.zzj == null && this.zzd != null) {
