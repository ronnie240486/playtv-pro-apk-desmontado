...
final class zzw extends zzba {
    ...
    public int hashCode() {
        zzsr<String, String> zzsrVar = this.adTagParameters;
        int iHashCode = zzsrVar == null ? 0 : zzsrVar.hashCode();
        String str = this.adTagUrl;
        int iHashCode2 = str == null ? 0 : str.hashCode();
        int i7 = iHashCode ^ 1000003;
        String str2 = this.adsResponse;
        int iHashCode3 = ((((i7 * 1000003) ^ iHashCode2) * 1000003) ^ (str2 == null ? 0 : str2.hashCode())) * 1000003;
        String str3 = this.apiKey;
        ...
        zzsr<String, String> zzsrVar2 = this.companionSlots;
        int iHashCode7 = (iHashCode6 ^ (zzsrVar2 == null ? 0 : zzsrVar2.hashCode())) * 1000003;
        Float f7 = this.contentDuration;
        int iHashCode8 = (iHashCode7 ^ (f7 == null ? 0 : f7.hashCode())) * 1000003;
        zzso<String> zzsoVar = this.contentKeywords;
        int iHashCode9 = (iHashCode8 ^ (zzsoVar == null ? 0 : zzsoVar.hashCode())) * 1000003;
        String str6 = this.contentSourceUrl;
        ...
        zzaw zzawVar = this.consentSettings;
        int iHashCode14 = (iHashCode13 ^ (zzawVar == null ? 0 : zzawVar.hashCode())) * 1000003;
        String str10 = this.customAssetKey;
        ...
        zzso<zzbo> zzsoVar2 = this.secureSignals;
        int iHashCode18 = (iHashCode17 ^ (zzsoVar2 == null ? 0 : zzsoVar2.hashCode())) * 1000003;
        zzsr<String, String> zzsrVar3 = this.extraParameters;
        int iHashCode19 = (iHashCode18 ^ (zzsrVar3 == null ? 0 : zzsrVar3.hashCode())) * 1000003;
        String str12 = this.format;
        int iHashCode20 = (iHashCode19 ^ (str12 == null ? 0 : str12.hashCode())) * 1000003;
        zzbc zzbcVar = this.identifierInfo;
        int iHashCode21 = (iHashCode20 ^ (zzbcVar == null ? 0 : zzbcVar.hashCode())) * 1000003;
        Boolean bool2 = this.isTv;
        int iHashCode22 = (iHashCode21 ^ (bool2 == null ? 0 : bool2.hashCode())) * 1000003;
        Boolean bool3 = this.isAndroidTvAdsFramework;
        int iHashCode23 = (iHashCode22 ^ (bool3 == null ? 0 : bool3.hashCode())) * 1000003;
        Integer num = this.linearAdSlotWidth;
        int iHashCode24 = (iHashCode23 ^ (num == null ? 0 : num.hashCode())) * 1000003;
        Integer num2 = this.linearAdSlotHeight;
        int iHashCode25 = (iHashCode24 ^ (num2 == null ? 0 : num2.hashCode())) * 1000003;
        String str13 = this.liveStreamEventId;
        int iHashCode26 = (iHashCode25 ^ (str13 == null ? 0 : str13.hashCode())) * 1000003;
        Float f8 = this.liveStreamPrefetchSeconds;
        int iHashCode27 = (iHashCode26 ^ (f8 == null ? 0 : f8.hashCode())) * 1000003;
        zzeb zzebVar = this.marketAppInfo;
        int iHashCode28 = (iHashCode27 ^ (zzebVar == null ? 0 : zzebVar.hashCode())) * 1000003;
        String str14 = this.msParameter;
        int iHashCode29 = (iHashCode28 ^ (str14 == null ? 0 : str14.hashCode())) * 1000003;
        String str15 = this.network;
        int iHashCode30 = (iHashCode29 ^ (str15 == null ? 0 : str15.hashCode())) * 1000003;
        zzbu zzbuVar = this.videoEnvironment;
        int iHashCode31 = (iHashCode30 ^ (zzbuVar == null ? 0 : zzbuVar.hashCode())) * 1000003;
        String str16 = this.networkCode;
        int iHashCode32 = (iHashCode31 ^ (str16 == null ? 0 : str16.hashCode())) * 1000003;
        String str17 = this.oAuthToken;
        int iHashCode33 = (iHashCode32 ^ (str17 == null ? 0 : str17.hashCode())) * 1000003;
        Boolean bool4 = this.omidAdSessionsOnStartedOnly;
        int iHashCode34 = (iHashCode33 ^ (bool4 == null ? 0 : bool4.hashCode())) * 1000003;
        zzsr<String, String> zzsrVar4 = this.platformSignals;
        int iHashCode35 = (iHashCode34 ^ (zzsrVar4 == null ? 0 : zzsrVar4.hashCode())) * 1000003;
        String str18 = this.projectNumber;
        int iHashCode36 = (iHashCode35 ^ (str18 == null ? 0 : str18.hashCode())) * 1000003;
        String str19 = this.region;
        int iHashCode37 = (iHashCode36 ^ (str19 == null ? 0 : str19.hashCode())) * 1000003;
        ImaSdkSettings imaSdkSettings = this.settings;
        int iHashCode38 = (iHashCode37 ^ (imaSdkSettings == null ? 0 : imaSdkSettings.hashCode())) * 1000003;
        Boolean bool5 = this.supportsExternalNavigation;
        int iHashCode39 = (iHashCode38 ^ (bool5 == null ? 0 : bool5.hashCode())) * 1000003;
        Boolean bool6 = this.supportsIconClickFallback;
        int iHashCode40 = (iHashCode39 ^ (bool6 == null ? 0 : bool6.hashCode())) * 1000003;
        Boolean bool7 = this.supportsNativeNetworking;
        int iHashCode41 = (iHashCode40 ^ (bool7 == null ? 0 : bool7.hashCode())) * 1000003;
        String str20 = this.streamActivityMonitorId;
        int iHashCode42 = (iHashCode41 ^ (str20 == null ? 0 : str20.hashCode())) * 1000003;
        Boolean bool8 = this.supportsResizing;
        int iHashCode43 = (iHashCode42 ^ (bool8 == null ? 0 : bool8.hashCode())) * 1000003;
        Boolean bool9 = this.useQAStreamBaseUrl;
        int iHashCode44 = (iHashCode43 ^ (bool9 == null ? 0 : bool9.hashCode())) * 1000003;
        Boolean bool10 = this.usesCustomVideoPlayback;
        int iHashCode45 = (iHashCode44 ^ (bool10 == null ? 0 : bool10.hashCode())) * 1000003;
        Float f9 = this.vastLoadTimeout;
        int iHashCode46 = (iHashCode45 ^ (f9 == null ? 0 : f9.hashCode())) * 1000003;
        String str21 = this.videoId;
        int iHashCode47 = (iHashCode46 ^ (str21 == null ? 0 : str21.hashCode())) * 1000003;
        zzef zzefVar = this.videoPlayActivation;
        int iHashCode48 = (iHashCode47 ^ (zzefVar == null ? 0 : zzefVar.hashCode())) * 1000003;
        zzeg zzegVar = this.videoContinuousPlay;
        int iHashCode49 = (iHashCode48 ^ (zzegVar == null ? 0 : zzegVar.hashCode())) * 1000003;
        zzeh zzehVar = this.videoPlayMuted;
        return iHashCode49 ^ (zzehVar != null ? zzehVar.hashCode() : 0);
    }
    ...
    public String toString() {
        ...
        Float f7 = this.contentDuration;
        String strValueOf3 = String.valueOf(this.contentKeywords);
        String str6 = this.contentSourceUrl;
        String str7 = this.contentTitle;
        String str8 = this.contentUrl;
        String str9 = this.contentSourceId;
        String strValueOf4 = String.valueOf(this.consentSettings);
        String str10 = this.customAssetKey;
        Boolean bool = this.enableNonce;
        String str11 = this.env;
        String strValueOf5 = String.valueOf(this.secureSignals);
        ...
        String str13 = this.liveStreamEventId;
        Float f8 = this.liveStreamPrefetchSeconds;
        String strValueOf8 = String.valueOf(this.marketAppInfo);
        String str14 = this.msParameter;
        String str15 = this.network;
        String strValueOf9 = String.valueOf(this.videoEnvironment);
        String str16 = this.networkCode;
        String str17 = this.oAuthToken;
        Boolean bool4 = this.omidAdSessionsOnStartedOnly;
        String strValueOf10 = String.valueOf(this.platformSignals);
        String str18 = this.projectNumber;
        String str19 = this.region;
        String strValueOf11 = String.valueOf(this.settings);
        Boolean bool5 = this.supportsExternalNavigation;
        Boolean bool6 = this.supportsIconClickFallback;
        Boolean bool7 = this.supportsNativeNetworking;
        String str20 = this.streamActivityMonitorId;
        ...
        Float f9 = this.vastLoadTimeout;
        String str21 = this.videoId;
        String strValueOf12 = String.valueOf(this.videoPlayActivation);
        String strValueOf13 = String.valueOf(this.videoContinuousPlay);
        String strValueOf14 = String.valueOf(this.videoPlayMuted);
        StringBuilder sbJ = a.j("GsonAdsRequest{adTagParameters=", strValueOf, ", adTagUrl=", str, ", adsResponse=");
        AbstractC2712e.t(sbJ, str2, ", apiKey=", str3, ", assetKey=");
        AbstractC2712e.t(sbJ, str4, ", authToken=", str5, ", companionSlots=");
        sbJ.append(strValueOf2);
        sbJ.append(", contentDuration=");
        sbJ.append(f7);
        sbJ.append(", contentKeywords=");
        AbstractC2712e.t(sbJ, strValueOf3, ", contentSourceUrl=", str6, ", contentTitle=");
        AbstractC2712e.t(sbJ, str7, ", contentUrl=", str8, ", contentSourceId=");
        AbstractC2712e.t(sbJ, str9, ", consentSettings=", strValueOf4, ", customAssetKey=");
        sbJ.append(str10);
        sbJ.append(", enableNonce=");
        sbJ.append(bool);
        sbJ.append(", env=");
        AbstractC2712e.t(sbJ, str11, ", secureSignals=", strValueOf5, ", extraParameters=");
        AbstractC2712e.t(sbJ, strValueOf6, ", format=", str12, ", identifierInfo=");
        sbJ.append(strValueOf7);
        sbJ.append(", isTv=");
        sbJ.append(bool2);
        sbJ.append(", isAndroidTvAdsFramework=");
        sbJ.append(bool3);
        sbJ.append(", linearAdSlotWidth=");
        sbJ.append(num);
        sbJ.append(", linearAdSlotHeight=");
        sbJ.append(num2);
        sbJ.append(", liveStreamEventId=");
        sbJ.append(str13);
        sbJ.append(", liveStreamPrefetchSeconds=");
        sbJ.append(f8);
        sbJ.append(", marketAppInfo=");
        sbJ.append(strValueOf8);
        sbJ.append(", msParameter=");
        AbstractC2712e.t(sbJ, str14, ", network=", str15, ", videoEnvironment=");
        AbstractC2712e.t(sbJ, strValueOf9, ", networkCode=", str16, ", oAuthToken=");
        sbJ.append(str17);
        sbJ.append(", omidAdSessionsOnStartedOnly=");
        sbJ.append(bool4);
        sbJ.append(", platformSignals=");
        AbstractC2712e.t(sbJ, strValueOf10, ", projectNumber=", str18, ", region=");
        AbstractC2712e.t(sbJ, str19, ", settings=", strValueOf11, ", supportsExternalNavigation=");
        sbJ.append(bool5);
        sbJ.append(", supportsIconClickFallback=");
        sbJ.append(bool6);
        sbJ.append(", supportsNativeNetworking=");
        sbJ.append(bool7);
        sbJ.append(", streamActivityMonitorId=");
        sbJ.append(str20);
        sbJ.append(", supportsResizing=");
        sbJ.append(bool8);
        sbJ.append(", useQAStreamBaseUrl=");
        sbJ.append(bool9);
        sbJ.append(", usesCustomVideoPlayback=");
        sbJ.append(bool10);
        sbJ.append(", vastLoadTimeout=");
        sbJ.append(f9);
        sbJ.append(", videoId=");
        AbstractC2712e.t(sbJ, str21, ", videoPlayActivation=", strValueOf12, ", videoContinuousPlay=");
        sbJ.append(strValueOf13);
        sbJ.append(", videoPlayMuted=");
        sbJ.append(strValueOf14);
        sbJ.append("}");
        return sbJ.toString();
    }
