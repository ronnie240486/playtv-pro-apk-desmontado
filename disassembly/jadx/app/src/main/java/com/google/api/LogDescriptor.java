...
public final class LogDescriptor extends AbstractC2617i1 implements P {
    ...
    static {
        ...
        AbstractC2617i1.registerDefaultInstance(LogDescriptor.class, logDescriptor);
    }
    ...
    public static LogDescriptor parseDelimitedFrom(InputStream inputStream) {
        return (LogDescriptor) AbstractC2617i1.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LogDescriptor parseFrom(ByteBuffer byteBuffer) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }
    ...
    public final Object dynamicMethod(EnumC2613h1 enumC2613h1, Object obj, Object obj2) {
        switch (enumC2613h1.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return AbstractC2617i1.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0001\u0000\u0001Ȉ\u0002\u001b\u0003Ȉ\u0004Ȉ", new Object[]{"name_", "labels_", LabelDescriptor.class, "description_", "displayName_"});
            case 3:
    ...
    public static LogDescriptor parseDelimitedFrom(InputStream inputStream, O0 o6) {
        return (LogDescriptor) AbstractC2617i1.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, o6);
    }

    public static LogDescriptor parseFrom(ByteBuffer byteBuffer, O0 o6) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, byteBuffer, o6);
    }

    public static LogDescriptor parseFrom(r rVar) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, rVar);
    }
    ...
    public static LogDescriptor parseFrom(r rVar, O0 o6) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, rVar, o6);
    }

    public static LogDescriptor parseFrom(byte[] bArr) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, bArr);
    }

    public static LogDescriptor parseFrom(byte[] bArr, O0 o6) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, bArr, o6);
    }

    public static LogDescriptor parseFrom(InputStream inputStream) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, inputStream);
    }

    public static LogDescriptor parseFrom(InputStream inputStream, O0 o6) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, inputStream, o6);
    }

    public static LogDescriptor parseFrom(AbstractC2670w abstractC2670w) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, abstractC2670w);
    }

    public static LogDescriptor parseFrom(AbstractC2670w abstractC2670w, O0 o6) {
        return (LogDescriptor) AbstractC2617i1.parseFrom(DEFAULT_INSTANCE, abstractC2670w, o6);
    }
}
