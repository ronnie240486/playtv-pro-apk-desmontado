...
public final class zzei implements AdsRequest {
    ...
    @Override // com.google.ads.interactivemedia.v3.api.AdsRequest
    public final void setAdWillAutoPlay(boolean z6) {
        this.zze = z6 ? zzef.AUTO : zzef.CLICK;
    }

    @Override // com.google.ads.interactivemedia.v3.api.AdsRequest
    public final void setAdWillPlayMuted(boolean z6) {
        this.zzf = z6 ? zzeh.MUTED : zzeh.UNMUTED;
    }
    ...
    @Override // com.google.ads.interactivemedia.v3.api.AdsRequest
    public final void setContinuousPlayback(boolean z6) {
        this.zzg = z6 ? zzeg.ON : zzeg.OFF;
    }
