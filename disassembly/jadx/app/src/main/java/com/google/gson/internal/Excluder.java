...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
        ...
        final boolean z6 = zExcludeClassChecks || excludeClassInStrategy(rawType, true);
        final boolean z7 = zExcludeClassChecks || excludeClassInStrategy(rawType, false);
        if (z6 || z7) {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM15clone = m15clone();
        excluderM15clone.serializeInnerClasses = false;
        return excluderM15clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM15clone = m15clone();
        excluderM15clone.requireExpose = true;
        return excluderM15clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z6, boolean z7) {
        ...
        if (z6) {
            ...
            excluderM15clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z7) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM15clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM15clone = m15clone();
        excluderM15clone.modifiers = 0;
        for (int i7 : iArr) {
            excluderM15clone.modifiers = i7 | excluderM15clone.modifiers;
        }
        return excluderM15clone;
    }
