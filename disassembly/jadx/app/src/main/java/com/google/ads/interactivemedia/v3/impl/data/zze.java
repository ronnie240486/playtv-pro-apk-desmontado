...
public final class zze implements AdsRenderingSettings {
    ...
    @Override // com.google.ads.interactivemedia.v3.api.AdsRenderingSettings
    public void setDisableUi(boolean z6) {
        this.disableUi = z6;
    }

    @Override // com.google.ads.interactivemedia.v3.api.AdsRenderingSettings
    public void setEnableCustomTabs(boolean z6) {
        this.enableCustomTabs = z6;
    }

    @Override // com.google.ads.interactivemedia.v3.api.AdsRenderingSettings
    public void setEnablePreloading(boolean z6) {
        this.enablePreloading = z6;
    }

    @Override // com.google.ads.interactivemedia.v3.api.AdsRenderingSettings
    public void setFocusSkipButtonWhenAvailable(boolean z6) {
        this.enableFocusSkipButton = z6;
    }
