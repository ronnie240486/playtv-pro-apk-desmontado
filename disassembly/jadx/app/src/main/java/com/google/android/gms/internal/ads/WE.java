...
public final class WE extends AbstractC2162yG {
    ...
    public static WE x(AbstractC1196fG abstractC1196fG, C1704pG c1704pG) {
        return (WE) AbstractC2162yG.k(zzb, abstractC1196fG, c1704pG);
    }
