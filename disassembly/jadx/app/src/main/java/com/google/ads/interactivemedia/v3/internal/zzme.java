...
public final class zzme extends zzmh {
    ...
    public final void zza() {
        if (this.zzi != null) {
            ...
            zzba zzbaVarZza = zzbb.zza();
            zzbaVarZza.zzb(zzkxVar.zza.longValue());
            zzbaVarZza.zzd(zzkxVar.zzb.longValue());
            zzbaVarZza.zze(zzkxVar.zzc.longValue());
            if (bool2.booleanValue()) {
                zzbaVarZza.zzc(zzkxVar.zze.longValue());
            }
            if (bool.booleanValue()) {
                zzbaVarZza.zza(zzkxVar.zzd.longValue());
            }
            this.zze.zzY((zzbb) zzbaVarZza.zzak());
        }
    }
}
