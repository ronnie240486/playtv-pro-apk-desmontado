...
public final class FF extends AbstractC2162yG {
    ...
    public static FF x(AbstractC1196fG abstractC1196fG, C1704pG c1704pG) {
        return (FF) AbstractC2162yG.k(zzb, abstractC1196fG, c1704pG);
    }
