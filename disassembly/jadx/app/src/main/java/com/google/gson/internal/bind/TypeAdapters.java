    ...
    static {
        ...
        TypeAdapter<BitSet> typeAdapterNullSafe2 = new TypeAdapter<BitSet>() { // from class: com.google.gson.internal.bind.TypeAdapters.2
            ...
            public BitSet read2(JsonReader jsonReader) throws IOException {
                ...
                while (jsonTokenPeek != JsonToken.END_ARRAY) {
                    int i8 = AnonymousClass35.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                    if (i8 == 1 || i8 == 2) {
                        int iNextInt = jsonReader.nextInt();
                        if (iNextInt != 0) {
                            if (iNextInt != 1) {
                                StringBuilder sbP = m.p("Invalid bitset value ", iNextInt, ", expected 0 or 1; at path ");
                                sbP.append(jsonReader.getPreviousPath());
        ...
        TypeAdapter<Number> typeAdapter2 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.5
            ...
            public Number read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbP = m.p("Lossy conversion from ", iNextInt, " to byte; at path ");
                    sbP.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbP.toString());
        ...
        TypeAdapter<Number> typeAdapter3 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.6
            ...
            public Number read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbP = m.p("Lossy conversion from ", iNextInt, " to short; at path ");
                    sbP.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbP.toString());
                } catch (NumberFormatException e7) {
                    throw new JsonSyntaxException(e7);
        ...
        TypeAdapter<Character> typeAdapter5 = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Character read2(JsonReader jsonReader) throws IOException {
                ...
                StringBuilder sbR = m.r("Expecting character, got: ", strNextString, "; at ");
        ...
        BIG_DECIMAL = new TypeAdapter<BigDecimal>() { // from class: com.google.gson.internal.bind.TypeAdapters.16
            ...
            public BigDecimal read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbR = m.r("Failed parsing '", strNextString, "' as BigDecimal; at path ");
                    sbR.append(jsonReader.getPreviousPath());
        ...
        BIG_INTEGER = new TypeAdapter<BigInteger>() { // from class: com.google.gson.internal.bind.TypeAdapters.17
            ...
            public BigInteger read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbR = m.r("Failed parsing '", strNextString, "' as BigInteger; at path ");
                    sbR.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbR.toString(), e7);
                }
            }
        ...
        TypeAdapter<UUID> typeAdapter12 = new TypeAdapter<UUID>() { // from class: com.google.gson.internal.bind.TypeAdapters.24
            ...
            public UUID read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbR = m.r("Failed parsing '", strNextString, "' as UUID; at path ");
                    sbR.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbR.toString(), e7);
                }
            }
        ...
        TypeAdapter<Currency> typeAdapterNullSafe6 = new TypeAdapter<Currency>() { // from class: com.google.gson.internal.bind.TypeAdapters.25
            ...
            public Currency read2(JsonReader jsonReader) throws IOException {
                ...
                try {
                    ...
                    StringBuilder sbR = m.r("Failed parsing '", strNextString, "' as Currency; at path ");
                    sbR.append(jsonReader.getPreviousPath());
                    throw new JsonSyntaxException(sbR.toString(), e7);
                }
            }
                ...
                if (cls.isAssignableFrom(rawType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.34.1
                        ...
                        public T1 read2(JsonReader jsonReader) {
                            T1 t6 = (T1) typeAdapter.read2(jsonReader);
                            if (t6 == null || rawType.isInstance(t6)) {
                                return t6;
                            }
                            throw new JsonSyntaxException("Expected a " + rawType.getName() + " but was " + t6.getClass().getName() + "; at path " + jsonReader.getPreviousPath());
                        }

                        @Override // com.google.gson.TypeAdapter
                        public void write(JsonWriter jsonWriter, T1 t6) {
