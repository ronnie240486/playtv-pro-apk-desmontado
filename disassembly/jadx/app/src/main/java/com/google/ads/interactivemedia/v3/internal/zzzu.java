...
final class zzzu extends zzxi {
    ...
    public final /* bridge */ /* synthetic */ Object read(zzacv zzacvVar) throws IOException {
        ...
        if (iZzt == 1) {
            ...
            while (zzacvVar.zzq()) {
                zzacvVar.zzj();
                Object obj = this.zzb.read(zzacvVar);
                if (map.put(obj, this.zzc.read(zzacvVar)) != null) {
                    throw new zzwz("duplicate key: ".concat(String.valueOf(obj)));
                }
                zzacvVar.zzl();
            }
            zzacvVar.zzl();
            ...
            while (zzacvVar.zzq()) {
                ...
                Object obj2 = this.zzb.read(zzacvVar);
                if (map.put(obj2, this.zzc.read(zzacvVar)) != null) {
                    throw new zzwz("duplicate key: ".concat(String.valueOf(obj2)));
                }
            }
            zzacvVar.zzm();
        }
