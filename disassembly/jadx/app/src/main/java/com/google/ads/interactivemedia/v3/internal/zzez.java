...
public final class zzez implements ImaSdkSettings {
    ...
    @Override // com.google.ads.interactivemedia.v3.api.ImaSdkSettings
    public void setAutoPlayAdBreaks(boolean z6) {
        this.autoPlayAdBreaks = z6;
    }
    ...
    @Override // com.google.ads.interactivemedia.v3.api.ImaSdkSettings
    public void setRestrictToCustomPlayer(boolean z6) {
        this.restrictToCustomPlayer = z6;
    }
    ...
    public String toString() {
        ...
        boolean z6 = this.restrictToCustomPlayer;
        boolean z7 = this.autoPlayAdBreaks;
        ...
        AbstractC2712e.t(sb, str2, ", playerVersion=", str3, ", language=");
        sb.append(str4);
