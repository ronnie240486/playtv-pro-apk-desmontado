...
final class zzk extends zzd {
    ...
    private zzk(int i7, zzso<String> zzsoVar, zzst<UiElement> zzstVar, boolean z6, boolean z7, double d7, boolean z8, int i8) {
        this.bitrate = i7;
        this.mimeTypes = zzsoVar;
        this.uiElements = zzstVar;
        this.enablePreloading = z6;
