...
class zzahf extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i8 = 0;
        if (i7 >= 0) {
            int iCompareTo = comparable.compareTo(((zzagz) this.zzb.get(i7)).zza());
            if (iCompareTo > 0) {
                return -(size + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i8 <= i7) {
            int i9 = (i8 + i7) / 2;
            int iCompareTo2 = comparable.compareTo(((zzagz) this.zzb.get(i9)).zza());
            if (iCompareTo2 < 0) {
                i7 = i9 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object get(Object obj) {
        ...
        return iZzk >= 0 ? ((zzagz) this.zzb.get(iZzk)).getValue() : this.zzc.get(comparable);
    }
    ...
    public final int hashCode() {
        ...
        int iHashCode = 0;
        for (int i7 = 0; i7 < iZzb; i7++) {
            iHashCode += ((zzagz) this.zzb.get(i7)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzk = zzk(comparable);
        if (iZzk >= 0) {
            return ((zzagz) this.zzb.get(iZzk)).setValue(obj);
        }
        zzn();
