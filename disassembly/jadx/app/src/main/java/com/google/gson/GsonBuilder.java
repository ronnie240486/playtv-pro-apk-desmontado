...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i7, int i8, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !str.trim().isEmpty()) {
            ...
            TypeAdapterFactory typeAdapterFactoryCreateAdapterFactory4 = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(i7, i8);
            if (z6) {
                typeAdapterFactoryCreateAdapterFactory3 = SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(i7, i8);
                TypeAdapterFactory typeAdapterFactoryCreateAdapterFactory5 = SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(i7, i8);
