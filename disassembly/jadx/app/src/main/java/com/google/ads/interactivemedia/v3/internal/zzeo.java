...
public class zzeo implements BaseDisplayContainer {
    ...
    public final void registerVideoControlsOverlay(View view) {
        ...
        com.google.ads.interactivemedia.v3.impl.data.zzax zzaxVarBuilder = com.google.ads.interactivemedia.v3.impl.data.zzay.builder();
        zzaxVarBuilder.view(view);
        zzaxVarBuilder.purpose(FriendlyObstructionPurpose.VIDEO_CONTROLS);
        com.google.ads.interactivemedia.v3.impl.data.zzay zzayVarBuild = zzaxVarBuilder.build();
        if (this.zze.contains(zzayVarBuild)) {
            return;
        }
        this.zze.add(zzayVarBuild);
        zzen zzenVar = this.zzf;
        if (zzenVar != null) {
            ((zzge) zzenVar).zzc(zzayVarBuild);
        }
    }
