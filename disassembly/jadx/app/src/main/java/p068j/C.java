...
public class C extends ImageView {
    ...
    public final r f26323y;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public final B f26324z;
    ...
    public final boolean hasOverlappingRendering() {
        return ((((ImageView) this.f26324z.f26312A).getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        B b7 = this.f26324z;
        if (b7 != null && drawable != null && !this.f26322A) {
            b7.f26317z = drawable.getLevel();
        }
        super.setImageDrawable(drawable);
        if (b7 != null) {
            b7.c();
            if (this.f26322A || ((ImageView) b7.f26312A).getDrawable() == null) {
                return;
            }
