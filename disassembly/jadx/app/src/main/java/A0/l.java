...
public abstract class l {
    ...
    public static final b f64a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final b f65b;
    ...
    static {
        ...
        f64a = new b("WEB_MESSAGE_GET_MESSAGE_PAYLOAD", "WEB_MESSAGE_GET_MESSAGE_PAYLOAD", 2);
        ...
        new b("SUPPRESS_ERROR_PAGE", "SUPPRESS_ERROR_PAGE", 2);
        new b("MULTI_PROCESS", "MULTI_PROCESS_QUERY", 2);
        new b("FORCE_DARK", "FORCE_DARK", 6);
        new b("FORCE_DARK_STRATEGY", "FORCE_DARK_BEHAVIOR", 2);
        f65b = new b("WEB_MESSAGE_LISTENER", "WEB_MESSAGE_LISTENER", 2);
