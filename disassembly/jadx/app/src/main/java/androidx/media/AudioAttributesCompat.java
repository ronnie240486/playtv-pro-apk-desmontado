...
public class AudioAttributesCompat implements c {
    ...
    public AudioAttributesImpl f10345a;
    ...
    public final boolean equals(Object obj) {
        ...
        AudioAttributesImpl audioAttributesImpl = this.f10345a;
        if (audioAttributesImpl == null) {
            return audioAttributesCompat.f10345a == null;
        }
        return audioAttributesImpl.equals(audioAttributesCompat.f10345a);
    }
    ...
    public AudioAttributesCompat(AudioAttributesImpl audioAttributesImpl) {
        this.f10345a = audioAttributesImpl;
    }
}
