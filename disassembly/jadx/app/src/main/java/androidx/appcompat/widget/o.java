...
public class o extends ImageButton {
    ...
    public final p f8821c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public boolean f8822d;

    public o(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.imageAspectRatioAdjust);
    }
    ...
    public final boolean hasOverlappingRendering() {
        return ((this.f8821c.f8824a.getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        p pVar = this.f8821c;
        if (pVar != null && drawable != null && !this.f8822d) {
