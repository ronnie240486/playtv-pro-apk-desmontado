...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec$Companion;-><init>(LQ5/d;)V
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Ld6/j;Ld6/i;)V
    .locals 1
    ...
    .line 23
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Ld6/j;

    .line 25
    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ld6/i;

    .line 27
    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    .line 29
    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Ld6/j;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Ld6/o;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Ld6/o;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Ld6/i;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ld6/i;

    .line 3
    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Ld6/j;
    .locals 0

    .line 1
    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Ld6/j;
...
.method private final detachTimeout(Ld6/o;)V
    .locals 3

    .line 1
    iget-object v0, p1, Ld6/o;->a:Ld6/E;

    .line 3
    sget-object v1, Ld6/E;->NONE:Ld6/E;
    ...
    .line 10
    iput-object v1, p1, Ld6/o;->a:Ld6/E;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v0, p1}, LX5/i;->t(Ljava/lang/String;Ljava/lang/String;)Z
...
.method private final newChunkedSink()Ld6/z;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Ld6/B;
    .locals 2
...
.method private final newFixedLengthSource(J)Ld6/B;
    .locals 2
...
.method private final newKnownLengthSink()Ld6/z;
    .locals 2
...
.method private final newUnknownLengthSource()Ld6/B;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Ld6/z;
    .locals 2
    ...
    .line 37
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Ld6/z;
    ...
    .line 48
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Ld6/z;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ld6/i;
...
.method public openResponseBodySource(Lokhttp3/Response;)Ld6/B;
    .locals 4
    ...
    .line 14
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Ld6/B;
    ...
    .line 33
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Ld6/B;
    ...
    .line 53
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Ld6/B;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    .line 26
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Ld6/B;ILjava/util/concurrent/TimeUnit;)Z
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    .line 17
    invoke-interface {v0, p2}, Ld6/i;->A(Ljava/lang/String;)Ld6/i;
    ...
    .line 23
    invoke-interface {p2, v0}, Ld6/i;->A(Ljava/lang/String;)Ld6/i;
    ...
    .line 35
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ld6/i;
    ...
    .line 41
    invoke-interface {v3, v4}, Ld6/i;->A(Ljava/lang/String;)Ld6/i;
    ...
    .line 55
    invoke-interface {v3, v1}, Ld6/i;->A(Ljava/lang/String;)Ld6/i;

    .line 58
    move-result-object v1

    .line 59
    invoke-interface {v1, v0}, Ld6/i;->A(Ljava/lang/String;)Ld6/i;
    ...
    .line 64
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Ld6/i;
