...
.method public static synthetic access$100(Lorg/videolan/libvlc/MediaPlayer;)Z
    .locals 0
...
.method public static synthetic access$300(Lorg/videolan/libvlc/MediaPlayer;)I
    .locals 0
...
.method public static synthetic access$400(Lorg/videolan/libvlc/MediaPlayer;[I)J
    .locals 0
...
.method public static synthetic access$500(Lorg/videolan/libvlc/MediaPlayer;JLjava/lang/String;)V
    .locals 0
...
.method private isAudioDigitalOutputCapable()Z
    .locals 2
...
.method private native nativeGetSelectedTrack(I)Lorg/videolan/libvlc/interfaces/IMedia$Track;
.end method
...
.method private native nativeGetTrackFromID(Ljava/lang/String;)Lorg/videolan/libvlc/interfaces/IMedia$Track;
.end method

.method private native nativeGetTracks(IZ)[Lorg/videolan/libvlc/interfaces/IMedia$Track;
.end method
...
.method private native nativeSelectTrack(Ljava/lang/String;)Z
.end method

.method private native nativeSelectTracks(ILjava/lang/String;)V
.end method
...
.method private native nativeUnselectTrackType(I)V
.end method
...
.method private registerAudioPlugV23(Z)V
    ...
    .line 7
    invoke-static {v0}, LU2/N;->D(Landroid/content/Context;)Ljava/lang/Object;
    ...
    .line 17
    invoke-static {v0}, LU2/N;->z(Landroid/media/AudioManager;)[Landroid/media/AudioDeviceInfo;

    .line 20
    move-result-object v1

    .line 21
    invoke-static {p1, v1}, LU2/N;->j(Landroid/media/AudioDeviceCallback;[Landroid/media/AudioDeviceInfo;)V

    .line 24
    iget-object p1, p0, Lorg/videolan/libvlc/MediaPlayer;->mAudioDeviceCallback:Landroid/media/AudioDeviceCallback;

    .line 26
    invoke-static {v0, p1}, LU2/N;->k(Landroid/media/AudioManager;Landroid/media/AudioDeviceCallback;)V
    ...
    .line 32
    invoke-static {v0, p1}, LU2/N;->C(Landroid/media/AudioManager;Landroid/media/AudioDeviceCallback;)V
...
.method private declared-synchronized setAudioOutputDeviceInternal(Ljava/lang/String;Z)Z
    ...
    .line 10
    invoke-direct {p0}, Lorg/videolan/libvlc/MediaPlayer;->isAudioDigitalOutputCapable()Z
...
.method public getSelectedTrack(I)Lorg/videolan/libvlc/interfaces/IMedia$Track;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lorg/videolan/libvlc/MediaPlayer;->nativeGetSelectedTrack(I)Lorg/videolan/libvlc/interfaces/IMedia$Track;
...
.method public getSelectedTracks(I)[Lorg/videolan/libvlc/interfaces/IMedia$Track;
    .locals 1
    ...
    .line 2
    invoke-direct {p0, p1, v0}, Lorg/videolan/libvlc/MediaPlayer;->nativeGetTracks(IZ)[Lorg/videolan/libvlc/interfaces/IMedia$Track;
...
.method public getTrackFromID(Ljava/lang/String;)Lorg/videolan/libvlc/interfaces/IMedia$Track;
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lorg/videolan/libvlc/MediaPlayer;->nativeGetTrackFromID(Ljava/lang/String;)Lorg/videolan/libvlc/interfaces/IMedia$Track;
...
.method public selectTrack(Ljava/lang/String;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lorg/videolan/libvlc/MediaPlayer;->nativeSelectTrack(Ljava/lang/String;)Z
...
.method public selectTracks(ILjava/lang/String;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Lorg/videolan/libvlc/MediaPlayer;->nativeSelectTracks(ILjava/lang/String;)V
...
.method public setVideoTrackEnabled(Z)V
    ...
    .line 4
    invoke-virtual {p0, v0}, Lorg/videolan/libvlc/MediaPlayer;->unselectTrackType(I)V
    ...
    .line 20
    invoke-virtual {p0, v0}, Lorg/videolan/libvlc/MediaPlayer;->getSelectedTrack(I)Lorg/videolan/libvlc/interfaces/IMedia$Track;
    ...
    .line 26
    invoke-virtual {p0, v0}, Lorg/videolan/libvlc/MediaPlayer;->getTracks(I)[Lorg/videolan/libvlc/interfaces/IMedia$Track;
    ...
    .line 35
    iget-object p1, p1, Lorg/videolan/libvlc/interfaces/IMedia$Track;->id:Ljava/lang/String;

    .line 37
    invoke-virtual {p0, p1}, Lorg/videolan/libvlc/MediaPlayer;->selectTrack(Ljava/lang/String;)Z
...
.method public unselectTrackType(I)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lorg/videolan/libvlc/MediaPlayer;->nativeUnselectTrackType(I)V
