...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/work/impl/workers/ConstraintTrackingWorker;->startWork()Lk9/c;
.end annotation
...
.method public final run()V
    ...
    invoke-virtual {v1, v2, v4, v3}, Lt1/h;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    .line 6
    :cond_0
    invoke-virtual {v0}, Landroidx/work/ListenableWorker;->getWorkerFactory()Lt1/p;
    ...
    .line 8
    invoke-virtual {v2, v4, v1, v5}, Lt1/p;->a(Landroid/content/Context;Ljava/lang/String;Landroidx/work/WorkerParameters;)Landroidx/work/ListenableWorker;
    ...
    invoke-virtual {v1, v2, v4, v3}, Lt1/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-static {v2}, Lu1/k;->D(Landroid/content/Context;)Lu1/k;

    move-result-object v2

    .line 12
    iget-object v2, v2, Lu1/k;->d:Landroidx/work/impl/WorkDatabase;

    .line 13
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->p()Lc2/q;
    ...
    invoke-virtual {v2, v4}, Lc2/r;->i(Ljava/lang/String;)Lc2/p;
    ...
    invoke-virtual {v0}, Landroidx/work/impl/workers/ConstraintTrackingWorker;->getTaskExecutor()Lf2/a;

    move-result-object v6

    invoke-direct {v4, v5, v6, v0}, Ly1/d;-><init>(Landroid/content/Context;Lf2/a;Ly1/c;)V
    ...
    invoke-virtual {v4, v2}, Ly1/d;->b(Ljava/lang/Iterable;)V
    ...
    invoke-virtual {v4, v2}, Ly1/d;->a(Ljava/lang/String;)Z
    ...
    invoke-virtual {v2, v5, v6, v7}, Lt1/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V

    .line 20
    :try_start_0
    iget-object v2, v0, Landroidx/work/impl/workers/ConstraintTrackingWorker;->k:Landroidx/work/ListenableWorker;

    invoke-virtual {v2}, Landroidx/work/ListenableWorker;->startWork()Lk9/c;
    ...
    invoke-direct {v5, v0, v2}, Lg2/a;-><init>(Landroidx/work/impl/workers/ConstraintTrackingWorker;Lk9/c;)V
    ...
    .line 23
    invoke-interface {v2, v5, v6}, Lk9/c;->f(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    :try_end_0
    ...
    invoke-virtual {v5, v6, v1, v4}, Lt1/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1, v6, v4, v3}, Lt1/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v5, v1, v3}, Lt1/h;->a(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
